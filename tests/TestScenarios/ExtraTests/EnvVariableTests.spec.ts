...
test.describe.skip("Environmental Variable Usage Test", () => {

    test("Test1 for accessing to Login page with environment variable BaseUrl", async ({page,}) => {
    ...
    test("Test2 for accessing to Login page with environment variable BaseUrl", async ({page,}) => {
        /* const baseUrl = process.env.BaseUrl;
          if (!baseUrl) {
              throw new Error("BaseUrl is not defined in the environment variables");
          }*/
